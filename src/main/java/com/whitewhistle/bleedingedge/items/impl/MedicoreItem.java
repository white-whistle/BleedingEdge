...
public class MedicoreItem extends ModTrinketItem{
    public MedicoreItem(Settings settings) {
        super(settings);
    }
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        SlotAttributes.addSlotModifier(modifiers, "chest/necklace", uuid, 2, EntityAttributeModifier.Operation.ADDITION);
