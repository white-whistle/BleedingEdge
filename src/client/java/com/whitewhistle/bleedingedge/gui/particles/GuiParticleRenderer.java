package com.whitewhistle.bleedingedge.gui.particles;

import com.whitewhistle.bleedingedge.mixin.client.HandledScreenAccessor;
...
public class GuiParticleRenderer implements ScreenEvents.AfterRender, ScreenEvents.AfterTick {
    ...
    public static GuiParticleRenderer INSTANCE = new GuiParticleRenderer();

    public ParticleSystem<GuiParticle> particleSystem = new ParticleSystem<>();
    public Vector2i mousePos = new Vector2i();
    public Random random = new Random();

    public void init() {
        ScreenEvents.AFTER_INIT.register((mc, screen, scaledWidth, scaledHeight) -> {
            GuiParticleRenderer.this.setupScreen(screen);
        });
    }
    ...
    public static void addParticle(GuiParticle particle) {
